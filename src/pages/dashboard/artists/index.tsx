        ...
        {artists.map((artist, i) => 
          <Card sx={{width: "100%", marginBottom: 3, display: 'flex', flexDirection: 'row' }} key={i}>
            ...
            <CardActions sx={{width: '10%', justifyContent: 'center'}}>
              ...
              <Link href={`/dashboard/artists/${artist.id}/delete`} passHref><IconButton color="primary"><DeleteIcon /></IconButton></Link>
              <Link href={`/dashboard/artists/${artist.id}`} passHref><IconButton color="secondary"><EditIcon /></IconButton></Link>
            </CardActions>
          </Card>
        )}
